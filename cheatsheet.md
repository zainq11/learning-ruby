...
# Ruby Cheatsheet
Forked from [here](https://raw.githubusercontent.com/ThibaultJanBeyer/cheatsheets/master/Ruby-Cheatsheet.md)
...
** ? and ! after method names**

[SO Answer](https://stackoverflow.com/questions/7179016/what-is-the-purpose-of-and-at-the-end-of-method-names)
...
In your example, `name.reverse` evaluates to a reversed string, but only after the `name.reverse!` line does the `name` variable actually _contain_ the reversed name. `name.is_binary_data?` looks like "is `name` binary data?".
